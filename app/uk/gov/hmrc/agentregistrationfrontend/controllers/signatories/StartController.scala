...
package uk.gov.hmrc.agentregistrationfrontend.controllers.signatories
...
import uk.gov.hmrc.agentregistrationfrontend.views.html.signatories.StartPage
    ...
    .async:
      implicit request: RequestHeader =>
        applicationService.findApplicationByLinkId(LinkId(linkId)).map {
          case Some(app) => Ok(startPage(app))
