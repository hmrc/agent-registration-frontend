      ...
      .async:
        implicit request: RequestWithData[IndividualProvidedDetails *: DataWithListOfIncompleteIndividuals] =>
          ...
          providedByApplicantSessionStore
            ...
            .map: _ =>
              Redirect(AppRoutes.apply.listdetails.providedbyapplicant.TelephoneNumberController.show) // TODO: Date of Birth should be next page even if coming from CYA as changing individual wipes everything - ideally via CYA controller when available
