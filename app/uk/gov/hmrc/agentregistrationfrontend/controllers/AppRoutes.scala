...
object AppRoutes:
  ...
  object apply:
    ...
    val NotAgentLoginController = applyRoutes.NotAgentLoginController
    ...
    object aboutyourbusiness:
      ...
      val OtherBusinessTypeController = aboutyourbusinessRoutes.OtherBusinessTypeController
    ...
    object listdetails:
      ...
      object providedbyapplicant:
        ...
        val SaUtrController = listdetailsProvideDetailsRoutes.SaUtrController
        val CheckYourAnswersController = listdetailsProvideDetailsRoutes.CheckYourAnswersController
    ...
    object checkfailed:
      ...
      val AgentAlreadySubscribedController = entitycheckfailedRoutes.AgentAlreadySubscribedController
    ...
    object internal:
      ...
      val AgentAlreadySubscribedCheckController = internalRoutes.AgentAlreadySubscribedCheckController
