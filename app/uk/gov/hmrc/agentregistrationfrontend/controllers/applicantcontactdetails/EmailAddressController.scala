                ...
                emailVerificationService.verifyEmail(
                  ...
                  mEmail = Some(
                    Email(
                      ...
                      enterUrl = routes.EmailAddressController.show.url
                    )
                  ),
                  continueUrl = routes.CheckYourAnswersController.show.url,
                  mBackUrl = Some(routes.EmailAddressController.show.url),
