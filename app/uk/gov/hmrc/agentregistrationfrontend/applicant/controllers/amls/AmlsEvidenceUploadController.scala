...
package uk.gov.hmrc.agentregistrationfrontend.applicant.controllers.amls
...
import uk.gov.hmrc.agentregistrationfrontend.applicant.model.upscan.UpscanErrorCode
