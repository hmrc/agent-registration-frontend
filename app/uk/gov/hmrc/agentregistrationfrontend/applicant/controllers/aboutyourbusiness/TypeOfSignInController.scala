...
import uk.gov.hmrc.agentregistrationfrontend.applicant.model.TypeOfSignIn.CreateSignInDetails
import uk.gov.hmrc.agentregistrationfrontend.applicant.model.TypeOfSignIn.HmrcOnlineServices
