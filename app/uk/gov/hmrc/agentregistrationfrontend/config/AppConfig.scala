...
class AppConfig @Inject() (
  ...
  val ivUpliftUrl: String = ConfigHelper.readConfigAsValidUrlString("urls.iv-uplift-url", configuration)
  ...
  val thisFrontendRelativeBaseUrl: String = configuration.get[String]("urls.this-frontend-relative")
  ...
  val contactFrontendId: String = configuration.get[String]("contact-frontend.serviceId")
