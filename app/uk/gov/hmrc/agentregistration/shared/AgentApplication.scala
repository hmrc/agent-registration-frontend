...
sealed trait AgentApplication:
  ...
  def hmrcEntityVerificationPassed: Option[EntityCheckResult]
  ...
  def getHmrcEntityVerificationPassed: EntityCheckResult = hmrcEntityVerificationPassed.getOrElse(expectedDataNotDefinedError("hmrcEntityVerificationPassed"))
