...
trait TdIndividualProvidedDetails { dependencies: TdBase =>
  ...
  object providedDetails:
    ...
    val afterRiskedFixableIndividualDetails: IndividualProvidedDetails = afterFinished
      .modify(_.riskingOutcomeIndividual)
      .setTo(Some(dependencies.riskingOutcomeIndividualDetailsFix))

    val afterRiskedNonFixable: IndividualProvidedDetails = afterFinished
      .modify(_.riskingOutcomeIndividual)
      .setTo(Some(dependencies.riskingOutcomeIndividualNonFixable))
    ...
    val afterRiskedFixableIndividualDetailsWithoutIds: IndividualProvidedDetails = afterFinished
      .modify(_.riskingOutcomeIndividual)
