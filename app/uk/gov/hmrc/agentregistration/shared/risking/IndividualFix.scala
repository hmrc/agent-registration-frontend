...
object IndividualFix:
  ...
  given OFormat[IndividualFix] =
    ...
    implicit val `_10._1`: OFormat[_10._1] = Json.format[_10._1]
    implicit val `_10._2`: OFormat[_10._2] = Json.format[_10._2]
  ...
  object _10:
    ...
    /** A fix corresponding to the [[IndividualFailure._10._1]] individual failure. */
    final case class _1(isConfirmed: Option[Boolean])
    extends IndividualFix

    /** A fix corresponding to the [[IndividualFailure._10._2]] individual failure. */
