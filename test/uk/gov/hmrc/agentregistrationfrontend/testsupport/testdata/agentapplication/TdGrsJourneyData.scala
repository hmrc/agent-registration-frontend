  ...
  object grsJourneyData:
    ...
    object llp:
      ...
      val journeyData: JourneyData = JourneyData(
        ...
        companyProfile = Some(dependencies.companyProfileLimitedPartnership),
        ctutr = None,
    ...
    object soleTrader:
      ...
      val journeyData: JourneyData = JourneyData(
        fullName = Some(dependencies.fullName),
    ...
    object ltd:
      ...
      val journeyData: JourneyData = JourneyData(
        ...
        trn = None,
        sautr = None,
        companyProfile = Some(dependencies.companyProfileLimited),
