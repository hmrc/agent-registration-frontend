...
extends ControllerSpec:
  ...
  private val path = "/agent-registration/conditions-not-yet-met/sole-trader/date-of-birth"
  ...
  "routes should have correct paths and methods" in:
    AppRoutes.fixablefailures.soletraderfailures.provideddetails.IndividualDateOfBirthController.show shouldBe Call(
      method = "GET",
      url = path
    )
    AppRoutes.fixablefailures.soletraderfailures.provideddetails.IndividualDateOfBirthController.submit shouldBe Call(
      method = "POST",
      url = path
    )
    AppRoutes.fixablefailures.soletraderfailures.provideddetails.IndividualDateOfBirthController.submit.url shouldBe AppRoutes.fixablefailures.soletraderfailures.provideddetails.IndividualDateOfBirthController.show.url
