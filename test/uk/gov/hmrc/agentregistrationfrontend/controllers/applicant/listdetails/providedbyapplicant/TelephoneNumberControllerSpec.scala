...
extends ControllerSpec:
  ...
  "routes should have correct paths and methods" in:
    ...
    AppRoutes.apply.listdetails.providedbyapplicant.TelephoneNumberController.submit.url shouldBe AppRoutes.apply.listdetails.providedbyapplicant.IndividualTelephoneNumberController.show.url
  ...
  s"POST $path with blank inputs should return 400" in:
    ...
    ).text() shouldBe "Error: Enter the number we should call to speak to you about this application"
    ApplyStubHelper.verifyConnectorsForAuthAction()
