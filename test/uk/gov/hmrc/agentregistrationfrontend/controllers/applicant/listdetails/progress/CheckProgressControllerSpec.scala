...
package uk.gov.hmrc.agentregistrationfrontend.controllers.applicant.listdetails.progress
...
extends ControllerSpec:
  ...
  private val path = "/agent-registration/apply/list-details/check-progress"
  ...
  "routes should have correct paths and methods" in:
    AppRoutes.apply.listdetails.progress.CheckProgressController.show shouldBe Call(
      method = "GET",
      url = path
    )
