...
extends ControllerSpec:
  ...
  "routes should have correct paths and methods" in:
    arf.aboutyourbusiness.routes.BusinessTypeSessionController.show shouldBe Call(
      method = "GET",
      url = path
    )
    arf.aboutyourbusiness.routes.BusinessTypeSessionController.submit shouldBe Call(
      method = "POST",
      url = path
    )
    arf.aboutyourbusiness.routes.BusinessTypeSessionController.submit.url shouldBe arf.aboutyourbusiness.routes.BusinessTypeSessionController.show.url
