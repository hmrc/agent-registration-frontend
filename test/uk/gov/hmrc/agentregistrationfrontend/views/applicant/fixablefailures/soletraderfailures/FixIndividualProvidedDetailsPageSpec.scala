...
import uk.gov.hmrc.agentregistrationfrontend.views.html.applicant.fixablefailures.soletraderfailures.FixIndividualProvidedDetailsPage
  ...
  "FixIndividualProvidedDetailsPage for individual" should:
    ...
    "should contain a link to the CYA page for identifiers" in:
      ...
      detailsCyaLink shouldBe TestLink(
        text = "Continue",
        href = AppRoutes.fixablefailures.soletraderfailures.provideddetails.CheckYourAnswersController.show.url
      )
