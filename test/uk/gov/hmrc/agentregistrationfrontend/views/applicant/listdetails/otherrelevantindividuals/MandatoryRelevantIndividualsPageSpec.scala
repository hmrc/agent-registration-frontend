...
class MandatoryRelevantIndividualsPageSpec
extends ViewSpec:

  private val formAction = AppRoutes.apply.listdetails.otherrelevantindividuals.MandatoryRelevantIndividualsController.submit

  private val viewTemplate: MandatoryRelevantIndividualsPage = app.injector.instanceOf[MandatoryRelevantIndividualsPage]

  "MandatoryRelevantIndividualsPage" should {
    ...
    val expectedHeading = "Tell us about the relevant individuals for Test Company"
    ...
    "render the partnership caption" in:
      doc
        ...
        .text() shouldBe "Partners and other relevant individuals"
    ...
    "render a form with an input of type text" in:
      ...
      form
        ...
        .selectOnlyOneElementOrFail()
        .text() shouldBe "What is the full name of the first relevant individual?"
