      ...
      val expectedSummaryList: TestSummaryList = TestSummaryList(
        List(
          TestSummaryRow(
            ...
            action = "/agent-registration/apply/agent-details/business-name"
          ),
          TestSummaryRow(
            key = "Telephone number",
            value = "(+44) 10794554342",
            action = "/agent-registration/apply/agent-details/telephone-number"
          ),
          TestSummaryRow(
            key = "Email address",
            value = "new@example.com",
            action = "/agent-registration/apply/agent-details/email-address"
          ),
          TestSummaryRow(
            key = "Correspondence address",
            value = "Registered Line 1 Registered Line 2 AB1 2CD GB",
            action = "/agent-registration/apply/agent-details/correspondence-address"
          )
        )
      )
