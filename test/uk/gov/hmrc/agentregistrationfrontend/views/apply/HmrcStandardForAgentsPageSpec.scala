...
class HmrcStandardForAgentsPageSpec
extends ViewSpec:

  val viewTemplate: HmrcStandardForAgentsPage = app.injector.instanceOf[HmrcStandardForAgentsPage]
  given agentApplicationRequest: RequestWithData4[DataWithApplication] = tdAll.makeAgentApplicationRequest(tdAll.agentApplicationLlp.afterDeclarationSubmitted)
  ...
  "HmrcStandardForAgentsPage" should:
    ...
    "have expected content" in:
      doc.mainContent shouldContainContent
        """
          ...
          |I agree that Test Company Name will meet the standard when working on behalf of clients.
          |Agree and continue
    ...
    "render a save and come back later button link" in:
      doc
        .mainContent
        .selectOrFail(s"form a[href='${AppRoutes.apply.SaveForLaterController.show.url}']")
        .selectOnlyOneElementOrFail()
